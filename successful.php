...
<h1 align="center">Successful Booking</h1>
    
<p align="center" style="font-size:20px">Date:<?php echo $_SESSION['date'];?></p><br>
...
<!--room1-->           
     ...
     <?php while ($a=mysqli_fetch_array($show1)){   
        if($a['Room01'] != ""){
            ...
            if($objResult){ ?>
                            <td  align="center" style="background-color:Tomato;">R 
            </td>
                            <?php 
            ...
            ?>
                     <td  align="center" style="background-color:green;" height="20px">       
...
<div style="margin-left: 20% ;" >
  <button ><a href="main.php" >Finish</a></button>   
</div>    
